				...
				<div class="row">
					...
					<div class="col-lg-4 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="#">CouponHunters</a></div>
				 	...
				 	if(in_array($lines[$x], $wishlist)){
						...
						<div class="char_item d-flex flex-row align-items-center justify-content-start">
							...
							<div class="char_content">
								<div class="char_title">'.$lines[$x].'</div>
								<div class="char_subtitle">Price '.rand(10000,60000).'Rs </div>
							</div>
							<div>
								<button type="submit" class="btn btn-success btn-sm" disabled style="margin-top:67px; margin-left:20px;" name =idval value='.$lines[$x].'>wishlist</button>
							</div>
						</div>
					</div>';
						...
						<div class="char_item d-flex flex-row align-items-center justify-content-start">
							...
							<div>
								<button type="submit" class="btn btn-success btn-sm" style="margin-top:67px; margin-left:20px;" name =idval value='.$lines[$x].'>wishlist</button>
							</div>
						</div>
					</div>';
				 	}
					...
					if (isset($_POST["idval"]))
					   {
							...
							$valuetoset = $wishlist." ".$_POST["idval"];
							if(strlen($wishlist) <= 0){
								$query= "UPDATE `users` SET `wishlist`=" .$_POST["idval"]." WHERE email='$e'";
								// echo $query;
								$result= mysqli_query($con,$query) or trigger_error(mysqli_error($con));
							}else{
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://MakeMyTrip.com" target="_blank">MMT</a>
